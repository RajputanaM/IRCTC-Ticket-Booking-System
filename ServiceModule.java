...
public class ServiceModule 
{
    ...
    {    
        ...
        //                 st.execute(query);
									  ...
									  pstmt.setInt(1, Integer.parseInt(schedule[0]));
									  pstmt.setString(2, schedule[1]);
									  pstmt.setInt(3, Integer.parseInt(schedule[2]));
									  pstmt.setInt(4, Integer.parseInt(schedule[3]));
									  pstmt.setInt(5, Integer.parseInt(schedule[2]));
									  pstmt.setInt(6, Integer.parseInt(schedule[3]));
									  pstmt.executeUpdate();
